      ...
      <div className="hero-left">
        ...
        <form className="hero-search" onSubmit={e => { e.preventDefault(); onGallery() }}>
          <div className="hero-search-inner">
            ...
            <input className="hero-search-input" placeholder="Search paintings, styles, spaces…" value={q} onChange={e => setQ(e.target.value)} />
          </div>
        ...
        <div className="hero-tags">
          ...
          <button className="hero-tag" onClick={() => onGallery()}>Watercolour</button>
          <button className="hero-tag" onClick={() => onGallery()}>Oil Paint</button>
          <button className="hero-tag" onClick={() => onGallery()}>Founder Office</button>
        </div>
      </div>

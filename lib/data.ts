...
export const FEED_ARTWORKS: ArtItem[] = [
  { id: 'fallback-1', name: 'Cerulean Dream', style: 'Abstract', img: 'https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=400&q=80', dim: '24 × 36 in', medium: 'Oil on Canvas' },
  { id: 'fallback-2', name: 'Golden Hour', style: 'Impressionism', img: 'https://images.unsplash.com/photo-1578301978693-85fa9c0320b9?w=400&q=80', dim: '18 × 24 in', medium: 'Acrylic' },
  { id: 'fallback-3', name: 'Urban Tide', style: 'Minimalism', img: 'https://images.unsplash.com/photo-1549490349-8643362247b5?w=400&q=80', dim: '20 × 28 in', medium: 'Mixed Media' },
  { id: 'fallback-4', name: 'Verdant Study', style: 'Botanical', img: 'https://images.unsplash.com/photo-1487530811015-780d05b1e5f4?w=400&q=80', dim: '16 × 20 in', medium: 'Watercolor' },
  { id: 'fallback-5', name: 'Dusk Geometry', style: 'Geometric', img: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=400&q=80', dim: '24 × 24 in', medium: 'Digital Print' },
  { id: 'fallback-6', name: 'Coastal Light', style: 'Landscape', img: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&q=80', dim: '30 × 40 in', medium: 'Oil on Canvas' },
  { id: 'fallback-7', name: 'Portrait #7', style: 'Portraiture', img: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&q=80', dim: '18 × 24 in', medium: 'Charcoal' },
  { id: 'fallback-8', name: 'Chromatic Field', style: 'Color Field', img: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=400&q=80', dim: '36 × 48 in', medium: 'Acrylic on Canvas' },
]

export const GALLERY_IMGS: ArtItem[] = [
  { id: 'fallback-1', name: 'Cerulean Dream', style: 'Abstract', img: 'https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=400&q=80', h: '280px', dim: '24×36 in', medium: 'Oil on Canvas' },
  { id: 'fallback-2', name: 'Golden Hour', style: 'Impressionism', img: 'https://images.unsplash.com/photo-1578301978693-85fa9c0320b9?w=400&q=80', h: '360px', dim: '18×24 in', medium: 'Acrylic' },
  { id: 'fallback-3', name: 'Urban Tide', style: 'Minimalism', img: 'https://images.unsplash.com/photo-1549490349-8643362247b5?w=400&q=80', h: '220px', dim: '20×28 in', medium: 'Mixed Media' },
  { id: 'fallback-4', name: 'Verdant Study', style: 'Botanical', img: 'https://images.unsplash.com/photo-1487530811015-780d05b1e5f4?w=400&q=80', h: '300px', dim: '16×20 in', medium: 'Watercolor' },
  { id: 'fallback-5', name: 'Dusk Geometry', style: 'Geometric', img: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=400&q=80', h: '240px', dim: '24×24 in', medium: 'Digital' },
  { id: 'fallback-6', name: 'Coastal Light', style: 'Landscape', img: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&q=80', h: '320px', dim: '30×40 in', medium: 'Oil on Canvas' },
  { id: 'fallback-7', name: 'Portrait #7', style: 'Portraiture', img: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&q=80', h: '260px', dim: '18×24 in', medium: 'Charcoal' },
  { id: 'fallback-8', name: 'Chromatic Field', style: 'Color Field', img: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=400&q=80', h: '380px', dim: '36×48 in', medium: 'Acrylic' },
  { id: 'fallback-9', name: 'Night Study', style: 'Abstract', img: 'https://images.unsplash.com/photo-1518998053901-5348d3961a04?w=400&q=80', h: '290px', dim: '20×30 in', medium: 'Oil on Canvas' },
  { id: 'fallback-10', name: 'City Rhythms', style: 'Urban', img: 'https://images.unsplash.com/photo-1514565131-fce0801e6785?w=400&q=80', h: '200px', dim: '18×18 in', medium: 'Acrylic' },
  { id: 'fallback-11', name: 'Forest Path', style: 'Landscape', img: 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=400&q=80', h: '340px', dim: '24×36 in', medium: 'Oil on Canvas' },
  { id: 'fallback-12', name: 'Still Life', style: 'Realism', img: 'https://images.unsplash.com/photo-1490750967868-88df5691cc56?w=400&q=80', h: '260px', dim: '14×18 in', medium: 'Watercolor' },
]
...
export const STYLES_PAGE_DATA = STYLES.map((s, i) => ({
  ...s,
